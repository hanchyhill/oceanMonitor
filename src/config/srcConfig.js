  ...
  */
  ...
  tab:{
    sst:[
      ...
      // local:'/static/remote-img/env/tcheat_wpac_2017.png',},
      // {name:'西太海温2',origin:'http://models.weatherbell.com/sst/wpac_cdas1.png',
      // local:'/static/remote-img/env/wpac_cdas1.png',},
      // {name:'海温距平2',origin:'http://models.weatherbell.com/sst/wpac_cdas1_anom.png',
      // local:'/static/remote-img/env/wpac_cdas1_anom.png',},
    ...
    mjo:[
      {name:'MJO(EC)',origin:'https://www.cpc.ncep.noaa.gov/products/precip/CWlink/MJO/CLIVAR/clivar_wh.shtml',
      local:'/static/remote-img/env/ECMF.png',},
      {name:'MJO(NCEP-GEFS)',origin:'https://www.cpc.ncep.noaa.gov/products/precip/CWlink/MJO/CLIVAR/clivar_wh.shtml',
      local:'/static/remote-img/env/ensplume_full.gif',},
    ],
  },
  imgs:{
    ...
    phSatAnalysis:{name:'热带卫星天气分析',origin:'http://www.typhoon2000.ph/t2kgraphsat.png',
    local:'/static/remote-img/env/t2kgraphsat.png',},
...
const nwpSrc = {
  speedDial:{
    ...
    hkoTrack:{
      link:'http://www.weather.gov.hk/probfcst/tc_spm_uc.htm',
      imgSrc:'/static/thumbnails/hko-fc.jpg',
      headInfo:'香港集合预报',
      head2:'熱帶氣旋路徑概率預報',
...
const bulletinSrc = {
  speedDial:{
    ...
    hkoTC:{
      link:'http://gb.weather.gov.hk/wxinfo/currwx/tc_fixarea_c.htm',
      imgSrc:'/static/thumbnails/hko-tc.jpg',
      headInfo:'香港天文台',
      head2:'香港天文台热带气旋预报',
      notes:'',
    },
    kmaTC:{
      link:'http://web.kma.go.kr/eng/weather/typoon/typhoon_5days.jsp',
      imgSrc:'/static/thumbnails/kma-tc.jpg',
      headInfo:'韩国气象局',
      head2:'KMA热带气旋预报',
      notes:'',
    },
    pagasaTC:{
      link:'https://www1.pagasa.dost.gov.ph/index.php/tropical-cyclones/weather-bulletins',
      imgSrc:'/static/thumbnails/pagasa-tc.jpg',
      headInfo:'菲律宾预报',
      head2:'PAGASA热带气旋通报',
      notes:'',
    },
    ...
    cwbTC:{
      link:'https://www.cwb.gov.tw/V7/prevent/typhoon/ty.htm',
...
const satSrc = {
  speedDial:{
    ...
    h8target:{
      link:'https://weather-models.info/latest/himawari-target.html',
      imgSrc:'/static/thumbnails/h8target.jpg',
      headInfo:'葵花8机动图',
      head2:'target Area',
...
const ascatImg ={
  descend:[
    ...
    [
      {name:'广东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds231.png',local:'/static/remote-img/ascat/WMBds231.png'},
      {name:'下降东海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds243.png',local:'/static/remote-img/ascat/WMBds243.png'},
      {name:'下降琉球以东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds255.png',local:'/static/remote-img/ascat/WMBds255.png'},
    ],
    [
      {name:'下降南海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds232.png',local:'/static/remote-img/ascat/WMBds232.png'},
      {name:'下降菲律宾北部', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds244.png',local:'/static/remote-img/ascat/WMBds244.png'},
      {name:'下降关岛', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds256.png',local:'/static/remote-img/ascat/WMBds256.png'},
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds233.png',local:'/static/remote-img/ascat/WMBds233.png',name:'下降南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds245.png',local:'/static/remote-img/ascat/WMBds245.png',name:'下降菲律宾南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBds257.png',local:'/static/remote-img/ascat/WMBds257.png',name:'下降菲东', },
    ],
  ],
  ascend:[
    [ 
    ...
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas231.png',local:'/static/remote-img/ascat/WMBas231.png',name:'上升广东', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas243.png',local:'/static/remote-img/ascat/WMBas243.png',name:'上升东海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas255.png',local:'/static/remote-img/ascat/WMBas255.png',name:'上升琉球以东', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas232.png',local:'/static/remote-img/ascat/WMBas232.png',name:'上升南海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas244.png',local:'/static/remote-img/ascat/WMBas244.png',name:'上升菲北', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas256.png',local:'/static/remote-img/ascat/WMBas256.png',name:'上升关岛', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas233.png',local:'/static/remote-img/ascat/WMBas233.png',name:'上升南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas245.png',local:'/static/remote-img/ascat/WMBas245.png',name:'上升菲南', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_META/zooms/WMBas257.png',local:'/static/remote-img/ascat/WMBas257.png',name:'上升菲东', },
    ],
  ],
  descendB:[
    [ 
    ...
    [
      {name:'广东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds231.png',local:'/static/remote-img/ascat/B-WMBds231.png'},
      {name:'下降东海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds243.png',local:'/static/remote-img/ascat/B-WMBds243.png'},
      {name:'下降琉球以东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds255.png',local:'/static/remote-img/ascat/B-WMBds255.png'},
    ],
    [
      {name:'下降南海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds232.png',local:'/static/remote-img/ascat/B-WMBds232.png'},
      {name:'下降菲律宾北部', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds244.png',local:'/static/remote-img/ascat/B-WMBds244.png'},
      {name:'下降关岛', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds256.png',local:'/static/remote-img/ascat/B-WMBds256.png'},
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds233.png',local:'/static/remote-img/ascat/B-WMBds233.png',name:'下降南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds245.png',local:'/static/remote-img/ascat/B-WMBds245.png',name:'下降菲律宾南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBds257.png',local:'/static/remote-img/ascat/B-WMBds257.png',name:'下降菲东', },
    ],
  ],
  ascendB:[
    [ 
    ...
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas231.png',local:'/static/remote-img/ascat/B-WMBas231.png',name:'上升广东', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas243.png',local:'/static/remote-img/ascat/B-WMBas243.png',name:'上升东海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas255.png',local:'/static/remote-img/ascat/B-WMBas255.png',name:'上升琉球以东', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas232.png',local:'/static/remote-img/ascat/B-WMBas232.png',name:'上升南海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas244.png',local:'/static/remote-img/ascat/B-WMBas244.png',name:'上升菲北', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas256.png',local:'/static/remote-img/ascat/B-WMBas256.png',name:'上升关岛', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas233.png',local:'/static/remote-img/ascat/B-WMBas233.png',name:'上升南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas245.png',local:'/static/remote-img/ascat/B-WMBas245.png',name:'上升菲南', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METB/zooms/WMBas257.png',local:'/static/remote-img/ascat/B-WMBas257.png',name:'上升菲东', },
    ],
  ],
  descendC:[
    [ 
    ...
    [
      {name:'广东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds231.png',local:'/static/remote-img/ascat/C-WMBds231.png'},
      {name:'下降东海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds243.png',local:'/static/remote-img/ascat/C-WMBds243.png'},
      {name:'下降琉球以东', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds255.png',local:'/static/remote-img/ascat/C-WMBds255.png'},
    ],
    [
      {name:'下降南海', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds232.png',local:'/static/remote-img/ascat/C-WMBds232.png'},
      {name:'下降菲律宾北部', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds244.png',local:'/static/remote-img/ascat/C-WMBds244.png'},
      {name:'下降关岛', origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds256.png',local:'/static/remote-img/ascat/C-WMBds256.png'},
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds233.png',local:'/static/remote-img/ascat/C-WMBds233.png',name:'下降南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds245.png',local:'/static/remote-img/ascat/C-WMBds245.png',name:'下降菲律宾南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBds257.png',local:'/static/remote-img/ascat/C-WMBds257.png',name:'下降菲东', },
    ],
  ],
  ascendC:[
    [ 
    ...
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas231.png',local:'/static/remote-img/ascat/C-WMBas231.png',name:'上升广东', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas243.png',local:'/static/remote-img/ascat/C-WMBas243.png',name:'上升东海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas255.png',local:'/static/remote-img/ascat/C-WMBas255.png',name:'上升琉球以东', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas232.png',local:'/static/remote-img/ascat/C-WMBas232.png',name:'上升南海', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas244.png',local:'/static/remote-img/ascat/C-WMBas244.png',name:'上升菲北', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas256.png',local:'/static/remote-img/ascat/C-WMBas256.png',name:'上升关岛', },
    ],
    [
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas233.png',local:'/static/remote-img/ascat/C-WMBas233.png',name:'上升南海南部', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas245.png',local:'/static/remote-img/ascat/C-WMBas245.png',name:'上升菲南', },
      {origin:'https://manati.star.nesdis.noaa.gov/ascat_images/cur_25km_METC/zooms/WMBas257.png',local:'/static/remote-img/ascat/C-WMBas257.png',name:'上升菲东', },
    ],
  ],
};
