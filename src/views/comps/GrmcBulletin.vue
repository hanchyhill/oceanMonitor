  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        hour,
        obsUrl:'http://research.gdmo.gq/api/di/http.action?interfaceId=getRACTyphoonObs4Tsid&dataFormat=html&tsid=%tsid&fcid=%ins',
        fcUrl: 'http://research.gdmo.gq/api/di/http.action?interfaceId=getRACTyphoonFst4Tsid&dataFormat=html&tsid=%tsid&fcid=%ins&ymdhms=%date',
      }
    },
    methods: {
      openObs(){// 打开台风观测接口
