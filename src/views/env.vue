    ...
    <Tabs type="card" :animated="false">
      ...
      <TabPane label="热带卫星天气分析">
        <a :href="phSatAnalysis.origin"  target="_blank">
          <img :src="phSatAnalysis.src" :alt="phSatAnalysis.name" width="80%">
        </a>
      </TabPane>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      tropicOutlook(){
        envSrc.imgs.tropicOutlook.src = envSrc.imgs.tropicOutlook[this.sourceFrom];
        return envSrc.imgs.tropicOutlook;
      },
      phSatAnalysis(){
        envSrc.imgs.phSatAnalysis.src = envSrc.imgs.phSatAnalysis[this.sourceFrom];
